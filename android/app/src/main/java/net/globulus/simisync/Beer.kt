...
data class Beer(val guid: String, val date: Double, val brand: String, val quantity: Int) {
    companion object {
        fun fromList(prop: SimiValue): List<Beer> {
            ...
            for (item in list) {
                ...
                beers.add(Beer(map["guid"] as String, (map["date"] as Map<*, *>)["timestamp"] as Double,
